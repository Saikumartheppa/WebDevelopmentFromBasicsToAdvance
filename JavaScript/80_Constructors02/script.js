class Employee{
    constructor(name , age){
        console.log("Employee Constructor is Executed");
        this.name = name;
        this.age = age;
    }
    login(){
...
class newEmployee extends Employee{
    ...
    login(){
        console.log(`${this.name} is Logged in 10 minutes Earlier`); // Name will be undefined
    }
    designation(){
        console.log(`${this.name}  designation is  ${this.role}`); // Name will be undefined
    }
}
